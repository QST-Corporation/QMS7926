...
typedef void(* hrs3300CB_t)(hr_ev_t* pev);

extern int hrs3300_register(hrs3300CB_t cb);
...
extern hrs3300_results_t Hrs3300_alg_get_results(void);
extern hrs3300_bp_results_t Hrs3300_alg_get_bp_results(void);
